...
import { Bell, Moon, Sun, Search, ChevronDown, Book, Cpu, User, Settings, LogOut, Square } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <nav className="w-full px-4 py-3 mt-2 flex justify-end relative">
      <div className="bg-white dark:bg-gray-800 px-6 py-2 rounded-full flex justify-end items-center gap-4 shadow-sm dark:shadow-gray-700/20">
        {/* Search Bar */}
        <div className="w-3/5 hidden md:block">
          <div className="relative w-full">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-full bg-gray-50 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={notificationsRef}>
            ...
            {showNotifications && (
              <div className="absolute right-[-4px] top-[3.6rem] w-[12.2rem] md:w-72 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50">
                {/* Arrow indicator */}
                <div className="absolute -top-2 right-4 w-4 h-4 rotate-45 bg-white dark:bg-gray-800 border-t border-l border-gray-200 dark:border-gray-700" />
                ...
                <ul className="divide-y divide-gray-200 dark:divide-gray-700 max-h-80 overflow-y-auto">
                  {notifications.map((notification) => (
                    <li key={notification.id}>
                      <div className="flex items-start p-3 hover:bg-gray-50 dark:hover:bg-gray-700">
          ...
          <div className="relative" ref={profileRef}>
            ...
            {showProfileMenu && (
              <div className="absolute right-0 top-[3.6rem] md:w-52 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50">
                {/* Arrow indicator */}
                <div className="absolute -top-2 right-4 w-4 h-4 rotate-45 bg-white dark:bg-gray-800 border-t border-l border-gray-200 dark:border-gray-700" />
