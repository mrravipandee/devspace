            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="w-full md:w-1/3 flex justify-center">
                    <div className="relative">
                        ...
                        />
                        <button className="absolute bottom-0 right-0 bg-white rounded-full p-2 shadow-md hover:scale-110 transition-transform">
                ...
                <div className="w-full md:w-2/3 text-center md:text-left">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-4">
                        <a
                            href="#projects"
                            className={`px-6 py-2 rounded-lg ${theme.primary} text-white hover:opacity-90 transition-opacity`}
                        >
                            View Projects
                        </a>
                        <a
                            href="#blog"
                            className={`px-6 py-2 rounded-lg ${theme.secondary} text-white hover:opacity-90 transition-opacity`}
                        >
                            View Blog
                        </a>
                        <a
