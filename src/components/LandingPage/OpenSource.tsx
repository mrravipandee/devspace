            ...
            <section className="py-20 bg-primaryText">
                <div className="container mx-auto px-6 max-w-7xl">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl mb-10 text-lightText">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                            {[
                                ...
                                <div
                                    key={index}
                                    className="p-6 rounded-lg bg-primary/20"
                                >
                        ...
                        <div className="rounded-xl p-8 max-w-2xl mx-auto bg-primary/20">
                            <h3 className="text-2xl font-semibold mb-4 text-white">Ready to contribute?</h3>
                            <p className="mb-6 text-lightText">
                                Join our growing community of contributors and help shape the future of DevSpace.
                            </p>
                            <a
